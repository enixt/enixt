...
const string strMessageMagic = "Enixt Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight > 0 && nHeight <= 4) {
        nSubsidy = 100000 * COIN; // 400k
    }
    else if (nHeight > 4 && nHeight <= 300) {
        nSubsidy = 1 * COIN; // prevent instamine
    }
    else if (nHeight > 300 && nHeight <= 10000) {
        nSubsidy = 4 * COIN; 
    }
    else if (nHeight > 10000 && nHeight <= 80000) {
        nSubsidy = 8 * COIN; 
    }
    ...
    else if (nHeight > 160000 && nHeight <= 240000) {
        nSubsidy = 4 * COIN;  
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 100 && pindexBest->nHeight+1 <= 10000) {
        nSubsidy = 5 * COIN; //1=pos 4=mn
    }
    else if (pindexBest->nHeight+1 > 10000 && pindexBest->nHeight+1 <= 80000)  {
        nSubsidy = 6 * COIN; //1.2=pos 4.8=mn
    }
    else if (pindexBest->nHeight+1 > 80000 && pindexBest->nHeight+1 <= 120000)  {
        nSubsidy = 8 * COIN; //1.6pos 6.4mn
    }
    else if (pindexBest->nHeight+1 > 120000 && pindexBest->nHeight+1 <= 160000) {
        nSubsidy = 10 * COIN; //2pos 8mn
    }
    else if (pindexBest->nHeight+1 > 160000 && pindexBest->nHeight+1 <= 240000) {
        nSubsidy = 12 * COIN;  //2.4pos 9.6mn
    }
...
bool CBlock::AcceptBlock()
{
    ...
    if (nBits != GetNextTargetRequired(pindexPrev, IsProofOfStake()) && hash != uint256("0x00006c3a37cd94ede5cfac4bd19041ca13c9e70266a173bfbf68157591fffd36") && hash != uint256
(""))
