...
int nAnonymizeEnixtAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Enixt
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Enixt
    // Mac: ~/Library/Application Support/Enixt
    // Unix: ~/.enixt
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Enixt";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "enixt.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "enixtd.pid"));
