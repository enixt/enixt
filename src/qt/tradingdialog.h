...
private slots:
    ...
    QString BuyENIX(QString OrderType, double Quantity, double Rate);
    QString SellENIX(QString OrderType, double Quantity, double Rate);
